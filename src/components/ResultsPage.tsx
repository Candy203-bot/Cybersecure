...
export function ResultsPage({
  ...
  const getComplianceLevel = () => {
    ...
    if (score >= 60)
      return { label: "Good", color: "bg-blue-500", textColor: "text-blue-700" };
    if (score >= 40)
      return {
        label: "Fair",
        color: "bg-yellow-500",
...
${
  score < 80
    ? `- Review and address non-compliant areas
...
Generated by CyberSecure - Botswana SME Compliance Tool
    ...
    a.href = url;
    a.download = `CyberSecure_Assessment_Report_${new Date()
      .toISOString()
      .split("T")[0]}.txt`;
    a.click();
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <Card className="p-8 mb-6 shadow-lg">
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center w-32 h-32 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 mb-4">
              <span className="text-5xl text-white font-semibold">{score}%</span>
            </div>
            <h2 className={`${complianceLevel.textColor} mb-2 font-medium`}>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="text-center p-4 bg-red-50 rounded-lg">
              ...
              <div className="text-2xl text-red-700 font-semibold">{noCount}</div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          ...
          <Card className="p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-gray-900 font-medium">Strong Areas</h3>
            </div>
          ...
          <Card className="p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h3 className="text-gray-900 font-medium">Areas for Improvement</h3>
            </div>
            <ul className="space-y-2">
              {responses
        ...
        <Card className="p-6 mb-6">
          ...
          <div className="space-y-4">
            {Array.from(new Set(responses.map((r) => r.regulation))).map(
              (reg) => {
                const regResponses = responses.filter(
                  (r) => r.regulation === reg
                );
                const regScore = Math.round(
                  (regResponses.filter((r) => r.answer === "Yes").length /
                    regResponses.length) *
                    100
                );
                return (
...
refining the results page to match the rest
