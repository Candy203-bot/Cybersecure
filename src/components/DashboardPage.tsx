      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <Card className="p-6">
            ...
            <div className={`text-2xl ${scoreStatus.color} mb-1`}>
              {lastScore}%
            </div>
            <div className={`text-sm ${scoreStatus.color}`}>
              {scoreStatus.label}
            </div>
          </Card>
          ...
          <Card className="p-6">
            ...
            <div className="text-2xl text-green-600 mb-1">
              +{lastScore - (mockHistory[1]?.score || lastScore - 10)}%
            </div>
              ...
              <div className={`p-6 rounded-lg ${scoreStatus.bgColor} mb-4`}>
                <div className="flex items-center justify-between mb-4">
                  <div>
                    ...
                    <div className={scoreStatus.color}>
                      {scoreStatus.label} Compliance
                    </div>
                  </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <div className="text-gray-900">
                          Assessment {mockHistory.length - index}
                        </div>
                        <div className="text-gray-500 text-sm">
          ...
          <div className="space-y-6">
            ...
            <Card className="p-6 bg-blue-50 border-blue-200">
              ...
              <p className="text-gray-600 text-sm">
                Regular assessments help you track progress and maintain
                compliance. We recommend conducting assessments quarterly.
              </p>
            </Card>
          </div>
        </div>
